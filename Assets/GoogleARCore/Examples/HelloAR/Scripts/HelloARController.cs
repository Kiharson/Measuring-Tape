        ...
        { 
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                ...
                else
                {
                    ...
                    var andyObject = Instantiate(marker, hit.Pose.position, hit.Pose.rotation);
                    ...
                    if (points.Count >= 2)
                    {
                        ...
                        var distanceObj = Instantiate(Text,(andyObject.transform.position + points[points.Count-2].transform.position)/2,Quaternion.identity);
                        distanceObj.transform.LookAt(andyObject.transform.position);
                        text.Add(distanceObj);
                        distanceObj.transform.localEulerAngles = new Vector3(90,andyObject.transform.localEulerAngles.y + 90,0);
                        float Value = Vector3.Distance(andyObject.transform.position, points[points.Count - 2].transform.position)*100;
                        print(Value);
             
                        string s = Value.ToString();
                        distanceObj.GetComponent<TextMesh>().text = s;
                    }
